...
fig_residual.add_hline(y=0, line_dash="dash", line_color="green", annotation_text="Mais realizados que atribuídos", annotation_position="bottom right")
# Show the line chart in Streamlit
# Add the "target" annotation
fig_residual.add_annotation(text="Mais atribúidos que realizados", xref="paper", yref="y", x=0.999, y=2.0, showarrow=False)
